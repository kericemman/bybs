  ...
  const values = [
    {
      ...
      description:
        "We prioritize progress, not polish. Your journey matters more than an impossible standard of 'having it all together.'",
      color: "text-[#00337C]",
      bg: "bg-[#00337C]/10",
    },
    {
      ...
      description:
        "True transformation begins when we stop pretending. We create space for uncomfortable truths that lead to breakthroughs.",
      color: "text-[#B76E79]",
      bg: "bg-[#B76E79]/10",
    },
    {
      ...
      description:
        "Your journey isn't meant to be walked alone. We believe in the power of shared wisdom and collective elevation.",
      color: "text-[#00337C]",
      bg: "bg-[#00337C]/10",
    },
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              <div
                className={`flex items-center justify-center w-16 h-16 rounded-2xl mb-6 ${value.bg} ${value.color} group-hover:scale-110 transition-transform duration-300`}
              >
                {value.icon}
              </div>
        ...
        >
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            These values shape <span className="font-semibold text-[#00337C]">how</span> we work,{" "}
            <span className="font-semibold text-[#B76E79]">who</span> we serve, and{" "}
            <span className="font-semibold text-[#00337C]">why</span> we're committed to your
            transformation.
          </p>
        </Motion.div>
      </div>
