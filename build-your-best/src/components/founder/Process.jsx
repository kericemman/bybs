  ...
  const approaches = [
    {
      ...
      description:
        "This is the stage of awakening. It’s where individuals begin to see themselves and their potential through new eyes.",
    ...
    },
    {
      ...
      description:
        "Before growth can flourish, healing must happen. At BYBS, we understand that many people carry emotional wounds, limiting beliefs, or unprocessed experiences that silently shape their choices and confidence.",
    ...
    },
    {
      ...
      description:
        "This is where transformation becomes visible. The Evolve stage helps individuals turn clarity and healing into intentional action. ",
    ...
    },
    {
      ...
      description:
        "With a strong foundation of self-awareness and healed wounds, individuals are empowered to make decisions that align with their true selves and long-term vision.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {approaches.map((approach, index) => (
            ...
            >
              {/* Gradient background */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${approach.color} opacity-90 group-hover:opacity-100 transition-opacity duration-300`}
              ></div>
        ...
        >
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Each element of our approach is designed to work together, creating a transformative
            journey from self-doubt to{" "}
            <span className="font-semibold text-[#00337C]">unshakable confidence</span> and{" "}
            <span className="font-semibold text-[#B76E79]">purposeful action</span>.
          </p>
        </Motion.div>
      </div>
    </section>
