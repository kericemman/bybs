  ...
  return (
    <section className="relative bg-white py-5 md:py-10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#00337C] mb-6">
            Our Purpose
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-lg text-gray-700">
                To see a generation of women living in full alignment with who they are healed,
                confident, and creating impact from a place of inner wholeness.
              </p>
            </Motion.div>
            ...
            >
              ...
              <p className="text-lg text-gray-700">
                To empower women to reconnect with their identity, shift their mindset, and grow
                with intention, so they can build a life and career that aligns with who they truly
                are.
              </p>
            </Motion.div>
          </div>
