      ...
      <section className="relative py-5 md:py-15 bg-gradient-to-br from-[#F5F9FF] to-[#FFF0F0] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          ...
          >
            ...
            <div className="mx-auto h-px w-24 bg-[#00337C]/10 shadow-[0_1px_4px_rgba(0,51,124,0.12)]"></div>
          </Motion.div>
            ...
            {[
              {
                ...
                link: "/coaching",
                color:
                  "bg-gradient-to-r from-[#00337C] to-[#1E4B9E] hover:from-[#1E4B9E] hover:to-[#00337C] text-white",
              },
              {
