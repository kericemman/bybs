...
export default function CTASection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-5 md:py-10 lg:py-15">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-lg md:text-xl font-bold text-[#00337C] mb-6">
              Ready for 1:1 Support?
            </h3>
            <p className="text-gray-700 mb-8 text-l">
              Book a coaching session today and let's create a{" "}
              <span className="font-semibold">personalized plan</span> that fits your life, goals,
              and growth pace.
            </p>
            <Motion.button
          ...
          >
            ...
            <p className="text-gray-700 mb-6 text-l">
              Get <span className="font-semibold">weekly insights</span>, tools, and motivation
