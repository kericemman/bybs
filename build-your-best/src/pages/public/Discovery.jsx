...
export default function QuizResults() {
  ...
  const results = {
    seeker: {
      ...
      image: "",
      description:
        "Right now, you're standing at the edge of something new—but it's not clear yet. You may feel lost, uncertain, or disconnected from your purpose.",
      questions: ["Who am I now?", "What do I want next?", "Is this all there is?"],
      experience: [
      ...
      resources: [
        {
          ...
          description:
            "A beautifully designed workbook to help you ask better questions and uncover deeper clarity.",
        ...
        },
        {
          ...
          description:
            "Start with 'What No One Tells You About Career Clarity' and 'Feeling Stuck? 5 Questions to Move Forward'.",
    ...
    rebuilder: {
      ...
      description:
        "You've been through something that shook you. Now, you're rising—but the pieces still feel scattered.",
      experience: [
      ...
      resources: [
        {
          ...
          description:
            "A practical but heart-centered guide to help you reflect, reset, and reclaim your worth.",
    ...
    planner: {
      ...
      description:
        "You're ambitious but carrying too much. Too many tabs open in your brain. Too many to-dos. Too much pressure.",
      experience: [
    ...
    aligned: {
      ...
      description:
        "You've done the work. Now your desire isn't 'more'—it's maintenance. You want rhythm and rituals that honor your peace.",
      experience: [
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative py-5 md:py-10 lg:py-15 bg-gradient-to-br from-[#F5F9FF] to-[#FFF0F0]">
      ...
      {/* Main Content */}
      <section className="relative py-5 md:py-10 lg:py-15 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {result.questions && (
              <>
                ...
                <ul className="mb-8">
                  {result.questions.map((question, index) => (
                    <li key={index} className="flex items-start">
                      <svg
                        className="flex-shrink-0 mt-1 mr-3 h-5 w-5 text-[#00337C]"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                ...
                <p className="italic mb-8 text-gray-600">
                  This isn't a crisis. It's an awakening. You're in a sacred season of self-inquiry
                  that will form the foundation of your next chapter.
                </p>
              </>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-[#F5F9FF] p-6 rounded-xl border border-[#00337C]/20">
                <h3 className="flex items-center text-xl font-bold text-gray-900 mb-4">
                  <svg
                    className="w-6 h-6 text-[#00337C] mr-2"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div className="bg-[#FFF0F0] p-6 rounded-xl border border-[#B76E79]/20">
                <h3 className="flex items-center text-xl font-bold text-gray-900 mb-4">
                  <svg
                    className="w-6 h-6 text-[#B76E79] mr-2"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <ul className="space-y-3">
                  {result.needs.map((item, index) => (
                    <li key={index} className="flex items-start">
                      <svg
                        className="flex-shrink-0 mt-1 mr-3 h-5 w-5 text-[#B76E79]"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                ...
                >
                  ...
                  <Link
                    ...
                    className={`inline-flex items-center font-medium transition-colors duration-200 ${
                      resource.type === "join"
                        ? "text-[#B76E79] hover:text-[#9E5A63]"
                        : "text-[#00337C] hover:text-[#1E4B9E]"
                    }`}
                  >
                    Get started
          ...
          <div className="text-center">
            ...
            >
              Begin Your{" "}
              {result.title.includes("Seeker")
                ? "Rediscovery"
                : result.title.includes("Rebuilder")
                  ? "Rebuilding"
                  : result.title.includes("Planner")
                    ? "Planning"
                    : "Alignment"}{" "}
              Journey →
            </Link>
