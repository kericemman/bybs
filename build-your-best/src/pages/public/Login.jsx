...
const Login = () => {
  ...
  return (
    <>
      <SEO title="Admin Login | Build Your Best Self" noindex />
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F5F9FF] to-[#FFF0F0] p-4">
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-light text-[#00337C] mb-2">Build Your Best Self</h1>
            <p className="text-gray-500 text-sm tracking-wide">Content Management System</p>
          </div>

          {/* Login Card */}
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
            <div className="h-px bg-[#00337C]/10 shadow-[0_1px_5px_rgba(0,51,124,0.12)]"></div>

            <div className="p-8 md:p-10">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-normal text-gray-800 mb-1">Admin Portal</h2>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      id="admin-email"
                      type="email"
                      placeholder="name@buildyourbestself.org"
