...
import { FileText, ShoppingBag, CheckCircle, Clock, TrendingUp, Loader2 } from "lucide-react";
    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {data.recentArticles.map((article) => (
              <div key={article._id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ml-3 ${
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <h3 className="text-lg font-medium text-gray-900 flex items-center">
              <ShoppingBag className="w-5 h-5 text-[#00337C] mr-2" />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      {order.product?.title || "Shop order"}
                    </p>
                  </div>
                  <span className="text-sm font-semibold text-[#B76E79] ml-3">
                    USD {Number(order.amount || 0).toFixed(2)}
                  </span>
                </div>
              </div>
            ))}
