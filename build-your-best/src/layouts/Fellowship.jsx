          ...
          >
            ...
            <div className="space-y-4 text-sm text-white/90 leading-relaxed">
              <p>
                ...
                personal branding project powered by the{" "}
                <strong>Excellence Foundation for South Sudan (EFSS)</strong>. It equips 20
                university students, entry-level professionals, and job seekers with the confidence
                and tools to stand out in today’s job market.
              </p>
              ...
              <p className="text-[#FF9E3B]/90 font-semibold mt-4">
                Duration: November 2025 – January 2026 Location: Juba (Hybrid)
              </p>
            </div>
            ...
            <div className="mt-8 flex justify-center">
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSezPOiRSX32YUrVHQBQnIfpYxx-TLxfUI27-V-rt-olf2Ywew/viewform"
